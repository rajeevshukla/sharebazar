...
<div class="ch-container">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="expensedetails.jsp">Detail</a>
        </li>
        <li>
...
<div class=" row">
 <div>
    ...
    <form class="form-horizontal" action="DoExpense" method="post">
                <fieldset>
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" style="width: 400px;" required name="home" class="form-control" placeholder="Home Rent">
                    </div>
                    <div class="clearfix"></div><br>

                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" required style="width: 400px;" name="phone" class="form-control" placeholder="Phone Bill">
                    </div>
                    <div class="clearfix"></div><br>
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" style="width: 400px;" required name="elec" class="form-control" placeholder="Electricity Bill">
                    </div>
                    <div class="clearfix"></div><br>
                     <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" style="width: 400px;" name="other" class="form-control" placeholder="Others Bill">
                    </div>
                    <div class="clearfix"></div><br>
