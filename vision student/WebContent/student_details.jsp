...
<div class=" row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Datatable + Students</h2>
  		...
  		<%
  			...
  			%>
  				...
  				<tr>
  					...
  					<td class="center"><%= rs.getString("cate") %></td>
					<td class="center"><%= rs.getDouble("fee") %></td>
					<td class="center"><%= rs.getDouble("pfee") %></td>
					<td class="center">
						<a class="btn btn-success" href="deposit.jsp?id=<%= rs.getInt("id") %>&phone=<%=rs.getString("phone") %>&cate=<%=rs.getString("cate")%>">
						<i class="glyphicon glyphicon-zoom-in icon-white"></i>Deposit</a>
						<a class="btn btn-info" href="sedit.jsp?id=<%= rs.getInt("id") %>">
						<i class="glyphicon glyphicon-zoom-in icon-white"></i>Edit</a>
						<a class="btn btn-danger" href="sdelete.jsp?id=<%= rs.getInt("id") %>">
						<i class="glyphicon glyphicon-zoom-in icon-white"></i>Delete</a>						
					</td>
  				</tr>
