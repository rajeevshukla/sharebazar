...
<%
	...
	double elec_bill = 0;
	double other_bill = 0;
	ResultSet rs = st.executeQuery("select * from expense where id = '"+id+"'");
	while(rs.next())
	{
		home_rent = rs.getDouble("home_rent");
		phone_bill = rs.getDouble("phone_bill");
		elec_bill = rs.getDouble("elec_bill");
		other_bill = rs.getDouble("other_bill");
	}
 %>

    <form class="form-horizontal" action="Exupdate" method="post">
                <fieldset>
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                       Home Rent <input type="text" required style="width: 400px;" name="name" value="<%=home_rent %>" class="form-control" placeholder="home_rent">
                    ...
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                       Phone Bill <input type="text" required style="width: 400px;" name="fname" value="<%=phone_bill %>" class="form-control" placeholder="phone_bill">
                    </div>
                    <div class="clearfix"></div><br>
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        Electricity Bill<input type="text" required style="width: 400px;" name="phone" value="<%=elec_bill %>" class="form-control" placeholder="elec_bill">
                    </div>
                    <div class="clearfix"></div><br>
                     <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        Other Bill<input type="text" required style="width: 400px;" name="email" value="<%=other_bill%>" class="form-control" placeholder="other_bill">
                    </div>
