...
<div class="ch-container">
    ...
    <ul class="breadcrumb">
        ...
        %>
            <a href="print.jsp?name=<%=name%>&phone=<%=phone%>" target="_blank">Print</a>
        </li>      
...
<div class=" row">
 <div>
    ...
    <form class="form-horizontal" action="DoStudent" method="post">
                <fieldset>
                    ...
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" style="width: 400px;" required name="fee" class="form-control" placeholder="Total Fees">
                    </div>
                    <div class="clearfix"></div><br>
                    
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" required style="width: 400px;" name="paidfee" class="form-control" placeholder="Fees Paid">
                    </div>
                    <div class="clearfix"></div><br>
