...
<%
		...
		while(rs.next())
		{
			...
			rema = rs.getDouble("remaining_fee");
		}
 %>
    ...
    <form class="form-horizontal" action="Deposit" method="post">
                <fieldset>
                    <div class="input-group input-group-lg">
                       ...
                       Total Fee <input type="text" required style="width: 400px;" name="fee" value="<%=fee %>" class="form-control" placeholder="fee" readonly="readonly">
                    ...
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        Remaining Amount<input type="text" required style="width: 400px;" name="rema" value="<%=rema %>" class="form-control" placeholder="rema" readonly="readonly" >
                    </div>
                    <div class="clearfix"></div><br>
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        Depsit<input type="text" required style="width: 400px;" name="deposit" value="" class="form-control" placeholder="Deposit">
                    </div>
