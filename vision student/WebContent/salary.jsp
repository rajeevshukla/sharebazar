...
%>
    <form class="form-horizontal" action="Salary" method="post">
                <fieldset>
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                       Salary  <input type="text" style="width: 400px;" required name="salary" value="<%=salary %>" class="form-control" placeholder="Fee" readonly="readonly">
             ...
             <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                       <select name="month" style="width: 400px;height: 40px;">
                    ...
                    <p class="center col-md-5">
                        <button type="submit" class="btn btn-primary">Proceed Salary</button>
                    </p>
                </fieldset>
            </form>
