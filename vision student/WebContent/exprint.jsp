    ...
    <ul class="breadcrumb">
  	...
  	<%
        ...
        double other_bill=0;		
  		...
  		ResultSet rs = st.executeQuery("select * from expense where id='"+id1+"'");
  		while(rs.next())
  		{
			home_rent = rs.getDouble("home_rent");
			p_bill = rs.getDouble("phone_bill");
			e_bill =rs.getDouble("elec_bill");
   ...
   <br>
 		<table>
 			<%
 			 ...
 			 %>
    		<tr>
    			<td><img src="Logo.jpg" width="150px" height="150px" /></td>
    			<td style="width: 100px;">&nbsp;</td>
   				<td>Date :<%=date %></td>
    		</tr> 			 
     		<tr>
    			<td>Home Rent: <%= home_rent %></td>
    			<td style="width: 100px;">&nbsp;</td>
   				<td>Phone Bill : <%= p_bill %></td>
    		</tr>
     		<tr>
    			<td>Electricity Bill: <%= e_bill%></td>
    			<td style="width: 100px;">&nbsp;</td>
   				<td>Other Bill :<%= other_bill %></td>
    		</tr>    	
