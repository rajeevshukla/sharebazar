...
<head>
    ...
    <meta charset="utf-8">
    <title>Teacher Salary Print</title>
...
<div class="ch-container">
    ...
    <ul class="breadcrumb">
  	...
  	<%
  		...
  		ResultSet rs = st.executeQuery("select * from teacher where id='"+id1+"'");
  		while(rs.next())
  		{
  		...
  		ResultSet rs1 = st1.executeQuery("select * from salary where t_id = "+id1+"");
  		while(rs1.next())
  		{
   ...
   <br>
 		<table>
    		...
    		<tr>
     		...
     		<tr>
    			<td>Month:<b><%= month %></b> </td>
    			<td style="width: 100px;">&nbsp;</td>
   				<td>Total Salary :<b><%= salary %></b></td>
    		</tr>
     		<tr>
    			<td> </td>
    			<td style="width: 100px;">&nbsp;</td>
   				<td>Status :<b>Paid</b></td>
    		</tr>    		    		   						 
 		</table>
