...
<%
	...
	while(rs.next())
	{
        ...
        ResultSet rs1=st1.executeQuery("select * from deposit where s_id='"+id+"'");	
 %>
...
<div id="printable">
<div><b style="font-size: 18px;font-family: sans-serif;"><center>Vision Institute</center></b></div>
<table>

    <%
    Date d=new Date();
    SimpleDateFormat sf=new SimpleDateFormat("dd/MM/yyyy");
    String s=sf.format(d).toString();
    %>
    ...
    <tr>
    <td><b>List of Paid Fees and Dates</b></td>
    <td></td>
    </tr>
    
    <tr>
    <td>Paid Fee : <b>Rs.<%=pfee %></b></td>
    <td style="width: 100px;">&nbsp;</td>
    <td>Date : <%=date %><b></b></td>
    </tr>  
   ...
   <%
    ...
    <tr>
    <td>Paid Fee : <b><%=rs1.getDouble("amount") %></b></td>
    <td style="width: 100px;">&nbsp;</td>
    <td>Date : <b><%=rs1.getString("date") %></b></td>
    </tr>
	<%
		tot+=rs1.getDouble("amount");
		}
		double totpaid = tot+pfee;
	 %>

    <tr>
    <td></td>
    <td style="width: 100px;">&nbsp;</td>
    <td><b>Total Paid Amount : <%=totpaid %></b></td>
    </tr>         		

    <tr>
    <td></td>
    <td style="width: 100px;">&nbsp;</td>
    <td><b>Total Remaining Amount : <%=fee-totpaid %></b></td>
    </tr>				
</table>
