...
public class ChangePasswordAction extends ActionSupport implements ModelDriven<ChangePasswordForm> {
	...
	public String execute() throws Exception {
		...
		try {
			PreparedStatement ps=connection.prepareStatement("UPDATE CUSTOMER_LOGIN SET PASSWORD=? WHERE MEMBERSHIP_ID=?");
	...
	public void validate() {
		...
		try {
			...
			PreparedStatement ps= connection.prepareStatement("SELECT PASSWORD FROM CUSTOMER_LOGIN WHERE MEMBERSHIP_ID=?");
