...
public class BuySellShareHistoryAction  extends ActionSupport{
	...
	public String execute() throws Exception {
		...
		PreparedStatement buyHistoryStatement= connection.prepareStatement("SELECT * FROM  BUYER_SELLER_MASTER  WHERE BUYER_MEMBERSHIP_ID=?");
		buyHistoryStatement.setString(1, ApplicationUtilities.getCurrentMemberIdFromSession());




		PreparedStatement sellHistoryStatement= connection.prepareStatement("SELECT * FROM  BUYER_SELLER_MASTER  WHERE SELLER_MEMBERSHIP_ID=?");
