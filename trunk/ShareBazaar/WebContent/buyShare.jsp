...
<body>
	<br><jsp:include page="headerHome.jsp"></jsp:include>
						...
						<tbody>
							...
							<tr>
								<td class="row"><label for="visitorLastName">Total
										amount</label></td>
								<td class="row"><input type="text" name="tranPasswordPost"
									id="showamount" class="short" required="" style="width: 100px;"
									disabled="disabled" />(this amount will be deducted from your
									account)</td>
