...
<%
	...
	ResultSet rs1 = st1.executeQuery("select * from teacher where cate='Engineering' or cate='Medical'");
	
	while(rs1.next())
	{
		al1.add(rs1.getInt("id"));
	}
	
	Statement st2 = cp.con.createStatement();
	ResultSet rs2 = st2.executeQuery("select * from teacher where cate='Other'");
	
	while(rs2.next())
	{
		al2.add(rs2.getInt("id"));
	}	
 %>
...
<div class=" row">
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="" title="" class="well top-block" href="#">
    ...
    <div class="col-md-3 col-sm-3 coct l-xs-6">
        <a data-toggle="" title="" class="well top-block" href="#">
            <i class="glyphicon glyphicon-shopping-cart yellow"></i>

            <div>Other Staffs</div>
            <div><%= al2.size() %></div>
