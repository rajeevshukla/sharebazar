  		...
  		<%
  			...
  			%>
  				...
  				<tr>
					...
					<td class="center"><%= rs.getDouble("salary") %></td>
					
					<td class="center">
						<a class="btn btn-success" href="salary.jsp?id=<%= rs.getInt("id") %>">
						<i class="glyphicon glyphicon-zoom-in icon-white"></i>Salary</a>
						<a class="btn btn-info" href="tedit.jsp?id=<%= rs.getInt("id") %>">
						<i class="glyphicon glyphicon-zoom-in icon-white"></i>Edit</a>
						<a class="btn btn-danger" href="tdelete.jsp?id=<%= rs.getInt("id") %>">
