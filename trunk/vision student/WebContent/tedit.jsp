...
<%
 ...
 %>
    ...
    <form class="form-horizontal" action="Tupdate" method="post">
                <fieldset>
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" required style="width: 400px;" name="name" value="<%=name %>" class="form-control" placeholder="Name">
                    ...
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" required style="width: 400px;" name="fname" value="<%=fname %>" class="form-control" placeholder="Father's Name">
                    </div>
                    <div class="clearfix"></div><br>
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" required style="width: 400px;" name="phone" value="<%=phone %>" class="form-control" placeholder="Phone">
                    </div>
                    <div class="clearfix"></div><br>
                     <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" required style="width: 400px;" name="email" value="<%=email %>" class="form-control" placeholder="Email">
                    </div>
                    ...
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <textarea style="width: 400px;" required name="address" class="form-control" placeholder="Address"><%=address %></textarea>
                    </div>
                    <div class="clearfix"></div><br>
  
                     <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" required style="width: 400px;" name="salary" value="<%=salary %>" class="form-control" placeholder="Salary">
                    </div>
