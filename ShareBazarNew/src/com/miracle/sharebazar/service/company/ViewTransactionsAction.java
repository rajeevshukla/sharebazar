...
public class ViewTransactionsAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		PreparedStatement ps = connection.prepareStatement("SELECT * FROM COMPANY_TRANSACTION WHERE MEMBERSHIP_ID=? ORDER BY DATE DESC" );
