...
public class ViewShareHoldersAction extends ActionSupport {
	...
	public String execute() throws Exception {
	 ...
	 PreparedStatement ps= connection.prepareStatement("SELECT BM.BUYER_MEMBERSHIP_ID ,CL.LOGIN_ID,BM.NO_OF_SHARE, BM.RATE_PER_SHARE, BM.DATE FROM BUYER_SELLER_MASTER BM , CUSTOMER_LOGIN CL WHERE CL.MEMBERSHIP_ID=BM.BUYER_MEMBERSHIP_ID AND  BM.SELLER_MEMBERSHIP_ID=?");
